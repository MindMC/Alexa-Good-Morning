...
def lambda_handler(event, context):
    ...
    """
     if (event['session']['application']['applicationId'] !=
             "amzn1.echo-sdk-ams.app.[amzn1.ask.skill.a97e7079-af1b-4aff-a20c-9261fd2c536a]"):
...
def reportSurf():
    ...
    text = multiple_replace(replace, temp)


    if text == "":
        surfReport = "The surf report feed appears to be down, please try again later."
    else:
